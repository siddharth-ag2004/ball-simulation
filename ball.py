...
class BouncingBallsGame:
    ...
    def _setup_collision_handler(self):
        ...
        self.space.on_collision(
            collision_type_a=1, collision_type_b=2, post_solve=self._on_collision
        )
    ...
    def _draw(self):
        ...
        pygame.draw.circle(
            self.screen, (255, 255, 255), self.circle_center, self.circle_radius, 10
        )
        ...
        for ball in self.colored_balls:
            ...
            pygame.draw.circle(
                self.screen, ball.color, (int(pos.x), int(pos.y)), int(ball.radius)
            )
        ...
        fps_text = font.render(
            f"FPS: {fps} | Balls: {self.balls_count}", True, (255, 255, 255)
        )
